...
const allCategories = [
  ...new Set(pictureData.map((picture) => picture.category)),
];
...
const Navbar = () => {
  ...
  const selectSub = (category) => {
    ...
    let subCategories = [
      ...new Set(newCategories.map((picture) => picture.subCategory)),
    ];
      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarNavDropdown">
          <ul className="navbar-nav ms-5 ">
            ...
            <li className="nav-item  ps-2 pe-4">
              <Link to="/shop" className="nav-link list-item">
                Shop
              </Link>
            </li>
            <li className="nav-item ps-2 pe-4">
              <Link to="/blog" className="nav-link list-item">
                Blog
              </Link>
            </li>
            <li className="nav-item dropdown ps-2 pe-4">
              <Link
                to="/"
                className="nav-link dropdown-toggle list-item"
                role="button"
            ...
            <li className="nav-item ps-2 pe-4">
              <Link to="/contact" className="nav-link list-item">
                Contact
              </Link>
            </li>
          </ul>
