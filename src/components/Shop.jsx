        ...
        <section className="shop-container">
          <div className="shop-text">
            ...
            <div className="sorting-row">
              <p>{`Showing ${indexOfFirstPost + 1}-${
                posts.length < 9 ? posts.length : indexOfLastPost
              } of ${posts.length} results`}</p>
              ...
              return (
                <div key={id} className="item-container">
                  ...
                  <div>
                    ...
                    >
                      <AiOutlineShopping className="shop-icon" /> add to cart
                    </button>
                  </div>
                  <div>
                    <Link
                    ...
                    >
                      <button className="shop-btn">
                        <AiFillEye className="shop-icon" /> view product
                      </button>
                    </Link>
                  </div>
                </div>
