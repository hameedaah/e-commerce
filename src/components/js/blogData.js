...
const blogData = [
  {
    ...
    mainText: `Fendi is an Italian luxury fashion house producing fur, ready-to-wear, leather goods, shoes, fragrances, eyewear, timepieces and accessories. Founded in Rome in 1925, Fendi is known for its fur, fur accessories, and leather goods. Since 2001, Fendi has been part of the “Fashion & Leather Goods” division of French group LVMH. Its headquarters are in Rome, in the Palazzo della Civiltà Italiana. The house of Fendi was launched in 1926 by Adele and Edoardo Fendi (1904-1954) as a fur and leather shop in Via del Plebiscito, Rome. In 1932 Adele and Edoardo Fendi opened a boutique in via Piave; the shop became a popular destination for tourists in Rome.
  ...
  },
  {
    ...
    mainText: `Tiffany & Co. is a luxury jewelry and specialty retailer, headquartered on Fifth Avenue in Manhattan. It sells jewelry, sterling silver, porcelain, crystal, stationery, fragrances, water bottles, watches, personal accessories, and leather goods.
        ...
        On January 7, 2021, French-based multinational LVMH Moët Hennessy Louis Vuitton acquired majority stake in Tiffany & Co for $15.8 billion and delisted Tiffany’s stock from the New York Stock Exchange.`,
  },
  {
    id: 5,
    title: "PRADA",
    ...
    mainText: `Prada S.p.A.  is an Italian luxury fashion house founded in 1913 in Milan by Mario Prada. It specializes in leather handbags, travel accessories, shoes, ready-to-wear, and other fashion accessories. Prada licenses its name and branding to Luxottica for eyewear and L’Oréal for fragrances.
...

  {
    ...
    mainText: `Gucci is an Italian high-end luxury fashion house based in Florence, Italy.Its product lines include handbags, ready-to-wear, footwear, accessories, and home decoration; and it licenses its name and branding to Coty, Inc. for fragrance and cosmetics under the name Gucci Beauty.
...

  {
    ...
    image: cartier,
    smallText:
      "Cartier International SNC, or simply Cartier, is a French luxury goods conglomerate which designs, manufactures, distributes, and sells jewellery, leather goods and watches.Founded by Louis-François Cartier (1819–1904) in Paris in 1847, the company remained under family control until 1964.",
    mainText: ` Cartier International SNC, or simply Cartier, is a French luxury goods conglomerate which designs, manufactures, distributes, and sells jewellery, leather goods and watches.Founded by Louis-François Cartier (1819–1904) in Paris in 1847, the company remained under family control until 1964. 
        ...
        Cartier has a long history of sales to royalty.King Edward VII of Great Britain referred to Cartier as "the jeweller of kings and the king of jewellers."For his coronation in 1902, Edward VII ordered 27 tiaras and issued a royal warrant to Cartier in 1904.Similar warrants soon followed from the courts of Spain, Portugal, Serbia, Russia and the House of Orléans.`,
  },
];
